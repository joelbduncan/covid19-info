...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
      <h1 class="display-4">COVID-19 FAQ</h1>
...
<h3>Q&A on coronaviruses (COVID-19)</h3>

<div class="accordion" id="covid-19-faq">
  <div class="card">
    <div class="card-header" id="heading1">
      <h5 class="mb-0">
        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
            <b>What is a coronavirus?</b>
        </button>
      </h5>
    </div>
    <div id="collapseOne" class="collapse show" aria-labelledby="heading1" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#covid-19-faq">
      <div class="card-body">
        <p>People can catch COVID-19 from others who have the virus. The disease can spread from person to person through small droplets from the nose or mouth which are spread when a person with COVID-19 coughs or exhales. These droplets land on objects and surfaces around the person. Other people then catch COVID-19 by touching these objects or surfaces, then touching their eyes, nose or mouth. People can also catch COVID-19 if they breathe in droplets from a person with COVID-19 who coughs out or exhales droplets. This is why it is important to stay more than 1 meter (3 feet) away from a person who is sick. </p><p>WHO is assessing ongoing research on the ways COVID-19 is spread and will continue to share updated findings.&nbsp;&nbsp;&nbsp;&nbsp;</p><div><h4><hr>Can the virus that causes COVID-19 be transmitted through the air?</h4></div><p>Studies to date suggest that the virus that causes COVID-19 is mainly transmitted through contact with respiratory droplets rather than through the air.&nbsp; See previous answer on “How does COVID-19 spread?”</p><div><h4><hr>Can CoVID-19 be caught from a person who has no symptoms?</h4></div><p>The main way the disease spreads is through respiratory droplets expelled by someone who is coughing. The risk of catching COVID-19 from someone with no symptoms at all is very low. However, many people with COVID-19 experience only mild symptoms. This is particularly true at the early stages of the disease. It is therefore possible to catch COVID-19 from someone who has, for example, just a mild cough and does not feel ill.&nbsp; WHO is assessing ongoing research on the period of transmission of COVID-19 and will continue to share updated findings.&nbsp;&nbsp;&nbsp;&nbsp;</p><div><h4><hr>Can I catch COVID-19 from the feces of someone with the disease?</h4></div><p>The risk of catching COVID-19 from the feces of an infected person appears to be low. While initial investigations suggest the virus may be present in feces in some cases, spread through this route is not a main feature of the outbreak. WHO is assessing ongoing research on the ways COVID-19 is spread and will continue to share new findings. Because this is a risk, however, it is another reason to clean hands regularly, after using the bathroom and before eating.&nbsp;</p>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    <div class="card-header" id="heading6">
      <h5 class="mb-0">
        ...
        <b>How likely am I to catch COVID-19?</b>
        </button>
      </h5>
    </div>
    <div id="collapse6" class="collapse" aria-labelledby="heading6" data-parent="#covid-19-faq">
      <div class="card-body">
      <p>The risk depends on where you  are - and more specifically, whether there is a COVID-19 outbreak unfolding there. </p>
      <p>For most people in most locations the risk of catching COVID-19 is still low. However, there are now places around the world (cities or areas) where the disease is spreading. For people living in, or visiting, these areas the risk of catching COVID-19 is higher. Governments and health authorities are taking vigorous action every time a new case of COVID-19 is identified. Be sure to comply with any local restrictions on travel, movement or large gatherings. Cooperating with disease control efforts will reduce your risk of catching or spreading COVID-19.</p>
      <p>COVID-19 outbreaks can be contained and transmission stopped, as has been shown in China and some other countries. Unfortunately, new outbreaks can emerge rapidly. It’s important to be aware of the situation where you are or intend to go. WHO publishes daily updates on the COVID-19 situation worldwide. </p>
      <p>You can see these at&nbsp;<a href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019/situation-reports">https://www.who.int/emergencies/diseases/novel-coronavirus-2019/situation-reports/</a> </p>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div id="collapse7" class="collapse" aria-labelledby="heading4" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse8" class="collapse" aria-labelledby="heading4" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse9" class="collapse" aria-labelledby="heading4" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse10" class="collapse" aria-labelledby="heading10" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse11" class="collapse" aria-labelledby="heading11" data-parent="#covid-19-faq">
      <div class="card-body">
        ...
        <p>Possible vaccines and some specific drug treatments are under investigation. They are being tested through clinical trials. WHO is coordinating efforts to develop vaccines and medicines to prevent and treat COVID-19. </p>
  ...
  <div class="card">
    ...
    <div id="collapse12" class="collapse" aria-labelledby="heading12" data-parent="#covid-19-faq">
      <div class="card-body">
        <p>No. The virus that causes COVID-19 and the one that caused the outbreak of Severe Acute Respiratory Syndrome (SARS) in 2003 are related to each other genetically, but the diseases they cause are quite different. </p>
        <p>SARS was more deadly but much less infectious than COVID-19. There have been no outbreaks of SARS anywhere in the world since 2003.</p>
      </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div id="collapse13" class="collapse" aria-labelledby="heading13" data-parent="#covid-19-faq">
      <div class="card-body">
        ...
        <p>WHO advises rational use of medical masks to avoid unnecessary wastage of precious resources and mis-use of masks  (see <a href="https://www.who.int/emergencies/diseases/novel-coronavirus-2019/advice-for-public/when-and-how-to-use-masks">Advice on the use of masks</a>). </p>
  ...
  <div class="card">
    ...
    <div id="collapse14" class="collapse" aria-labelledby="heading14" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse15" class="collapse" aria-labelledby="heading15" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse16" class="collapse" aria-labelledby="heading16" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse17" class="collapse" aria-labelledby="heading17" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div id="collapse18" class="collapse" aria-labelledby="heading18" data-parent="#covid-19-faq">
      <div class="card-body">
        <p>It is not certain how long the virus that causes COVID-19 survives on surfaces, but it seems to behave like other coronaviruses. Studies suggest that coronaviruses (including preliminary information on the COVID-19 virus) may persist on surfaces for a few hours or up to several days. This may vary under different conditions (e.g. type of surface, temperature or humidity of the environment).</p>
        <p>If you think a surface may be infected, clean it with simple disinfectant to kill the virus and protect yourself and others. Clean your hands with an alcohol-based hand rub or wash them with soap and water. Avoid touching your eyes, mouth, or nose.</p>
    </div>
    </div>
  </div>
  ...
  <div class="card">
    ...
    <div id="collapse19" class="collapse" aria-labelledby="heading19" data-parent="#covid-19-faq">
      <div class="card-body">
  ...
  <div class="card">
    <div class="card-header" id="heading20">
      <h5 class="mb-0">
        ...
        <b>Is there anything I should not do?</b>
        </button>
      </h5>
    </div>
    <div id="collapse20" class="collapse" aria-labelledby="heading20" data-parent="#covid-19-faq">
      <div class="card-body">
        <p>The following measures <strong><span style="text-decoration:underline;">ARE NOT</span></strong> effective against COVID-2019 and can be harmful:</p>
        <ul><li>Smoking</li><li>Wearing multiple masks</li><li>Taking antibiotics (See question 10 "<em>Are there any medicines of therapies that can prevent or cure COVID-19?</em>")</li></ul>
        <p><strong>In any case, if you have fever, cough and difficulty breathing seek medical care early</strong>  to reduce the risk of developing a more severe infection and be sure to share your recent travel history with your health care provider.</p>
      </div>
    </div>
  </div>
